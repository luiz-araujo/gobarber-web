...
describe('ForgotPassword Page', () => {
  ...
  it('should be able to recover password link', async () => {
  ...
  it('should not be able to recover password link', async () => {
    const { getByPlaceholderText, getByText } = render(<ForgotPassword />);
  ...
  it('should display an error if recover password link fails', async () => {
    const { getByPlaceholderText, getByText } = render(<ForgotPassword />);
